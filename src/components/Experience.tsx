    ...
    <section className="py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-1 h-full bg-gradient-to-b from-blue-400 via-purple-400 to-pink-400 rounded-full" />
          ...
          {experiences.map((exp, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`relative flex items-center mb-16 md:justify-between ${
            ...
            >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="absolute left-4 md:left-1/2 transform -translate-x-1/2 w-4 h-4 bg-blue-400 rounded-full border-4 border-gray-900 z-10"
              />
              ...
              >
                <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-700/50 rounded-lg p-5 md:p-6 hover:border-blue-400/50 transition-all duration-300">
                  <div className="flex flex-col sm:flex-row sm:items-center mb-4 gap-4">
                    <div className="p-2 bg-blue-500/20 rounded-full w-fit">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.skills.map((skill) => (
                      <span
                        key={skill}
                        className="px-2 py-1 bg-purple-500/20 text-purple-300 rounded-full text-xs border border-purple-400/30"
                      >
                        {skill}
                      </span>
                    ))}
